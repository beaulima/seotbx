...
setuptools.setup(
    ...
    description="Processing toolbox for Remote Sensing and Geospatial Analysis",
    long_description="%s\n%s" % (
    ...
    author_email="mario.beaulieu.qc.ca@gmail.com",
    url="https://github.com/beaulima/seotbx",
    ...
    classifiers=[
        ...
        "Topic :: Scientific/Engineering :: Geospatial Analysis",
    ...
    keywords=["gdal", "snappy", "pytorch", "polsarpro"],
